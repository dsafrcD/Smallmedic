...
<div class="card">
    <div class="card-body">
        <form action="<?php echo e(route("admin.atendimentos.update", [$atendimento->id])); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group <?php echo e($errors->has('procedimento') ? 'has-error' : ''); ?>">
                ...
                <select id="procedimento" name="procedimento" class="form-control" required>
                    ...
                    <?php $__currentLoopData = App\Atendimento::PROCEDIMENTO_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" <?php echo e(old('procedimento', $atendimento->procedimento) === (string)$key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group <?php echo e($errors->has('duracao') ? 'has-error' : ''); ?>">
                ...
                <select id="duracao" name="duracao" class="form-control" required>
                    <option value="" disabled <?php echo e(old('duracao', null) === null ? 'selected' : ''); ?>><?php echo e(trans('global.pleaseSelect')); ?></option>
                    <?php $__currentLoopData = App\Atendimento::DURACAO_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>" <?php echo e(old('duracao', $atendimento->duracao) === (string)$key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Irroba\Consultorio\resources\views/admin/atendimentos/edit.blade.php ENDPATH**/ ?>
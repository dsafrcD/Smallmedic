...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.paciente.title_singular')); ?>

    </div>

    <div class="card-body">
        <form action="<?php echo e(route("admin.pacientes.update", [$paciente->id])); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group <?php echo e($errors->has('Medico') ? 'has-error' : ''); ?>">
                <label for="Medico"><?php echo e(trans('cruds.paciente.fields.Medico')); ?>*</label>
                <input type="text" id="Medico" name="Medico" class="form-control" value="<?php echo e(old('Medico', isset($paciente) ? $paciente->Medico : '')); ?>" required>
                <?php if($errors->has('Medico')): ?>
                    <p class="help-block">
                        <?php echo e($errors->first('Medico')); ?>

                    </p>
                <?php endif; ?>
                <p class="helper-block">
                    <?php echo e(trans('cruds.paciente.fields.Medico_helper')); ?>
            ...
            <div class="form-group <?php echo e($errors->has('sexo') ? 'has-error' : ''); ?>">
                ...
                <?php $__currentLoopData = App\Paciente::SEXO_RADIO; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <input id="sexo_<?php echo e($key); ?>" name="sexo" type="radio" value="<?php echo e($key); ?>" <?php echo e(old('sexo', $paciente->sexo) === (string)$key ? 'checked' : ''); ?> required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Irroba\Consultorio\resources\views/admin/pacientes/edit.blade.php ENDPATH**/ ?>
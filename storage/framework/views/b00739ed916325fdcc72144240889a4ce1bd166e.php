    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.atendimentos.store")); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group <?php echo e($errors->has('paciente_id') ? 'has-error' : ''); ?>">
                ...
                <input type="text" id="Medico" name="Medico" value="<?php echo e(Auth::user()->name); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Irroba\Consultorio\resources\views/admin/atendimentos/create.blade.php ENDPATH**/ ?>
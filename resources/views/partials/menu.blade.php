<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    <a href="#" class="brand-link">
        <span class="brand-text font-weight-light">Olá {{ Auth::user()->name }}</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('atendimento_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.atendimentos.index") }}" class="nav-link {{ request()->is('admin/atendimentos') || request()->is('admin/atendimentos/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-user-md">

                            </i>
                            <p>
                                <span>{{ trans('cruds.atendimento.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan

    ...
    <div class="card-body">
        <form action="{{ route("admin.pacientes.update", [$paciente->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('nome') ? 'has-error' : '' }}">
                ...
                <input type="hidden" id="nome" name="nome" class="form-control" value="{{ old('nome', isset($paciente) ? $paciente->nome : '') }}" required>
                @if($errors->has('nome'))
                    <p class="help-block">
                        {{ $errors->first('nome') }}
                    </p>
            ...
            <div class="form-group {{ $errors->has('Medico') ? 'has-error' : '' }}">
                <label for="Medico">{{ trans('cruds.paciente.fields.Medico') }}*</label>
                <input type="text" id="Medico" name="Medico" class="form-control" value="{{ old('Medico', isset($paciente) ? $paciente->Medico : '') }}" required>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.paciente.fields.Medico_helper') }}
                </p>
            </div>
            ...
            <div class="form-group {{ $errors->has('sexo') ? 'has-error' : '' }}">
                ...
                @foreach(App\Paciente::SEXO_RADIO as $key => $label)
                    <div>
                        <input id="sexo_{{ $key }}" name="sexo" type="radio" value="{{ $key }}" {{ old('sexo', $paciente->sexo) === (string)$key ? 'checked' : '' }} required>
